...
class Ansi {
	...
	public static function stripColor(output: String): String {
		...
		if (colorSupported == null) {
			var term = platform.VSys.getEnv("TERM");
			...
			if (term == "dumb") {
				...
				if (colorSupported != true) {
					colorSupported = platform.VSys.getEnv("TERM_PROGRAM") == "iTerm.app"
						|| platform.VSys.getEnv("TERM_PROGRAM") == "Apple_Terminal"
						|| platform.VSys.getEnv("COLORTERM") != null
						|| platform.VSys.getEnv("ANSICON") != null
						|| platform.VSys.getEnv("ConEmuANSI") != null
						|| platform.VSys.getEnv("WT_SESSION") != null;
				}
			}
		}
